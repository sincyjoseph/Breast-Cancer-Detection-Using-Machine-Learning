...
Original file is located at
    https://colab.research.google.com/drive/1B6HOVKeYsH3W27uLsX_zZT6M_oBZfBG1
...
#Splitting the data set into a feature data set also known as the
#independent data set (X), and a target data set also known as the dependent data set (Y).
...
#(e.g. Logistic Regression, Decision Tree Classifier, Random Forest Classifier) to make the classification
